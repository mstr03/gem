...
file_paths.each do |period, file_path|
  ...
  existing_data["#{current_month}-#{current_year}"] = results_12_months if period == "12_months"
  existing_data["#{current_month}-#{current_year}"] = results_6_months if period == "6_months"
  existing_data["#{current_month}-#{current_year}"] = results_3_months if period == "3_months"
